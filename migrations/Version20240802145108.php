 ...
 */
final class Version20240802145108 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE message (id INT AUTO_INCREMENT NOT NULL, sent_by_id INT NOT NULL, conversation_id INT NOT NULL, content LONGTEXT NOT NULL, send_at DATETIME NOT NULL, is_read TINYINT(1) NOT NULL, read_at DATETIME DEFAULT NULL, INDEX IDX_B6BD307FA45BB98C (sent_by_id), INDEX IDX_B6BD307F9AC0396 (conversation_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
